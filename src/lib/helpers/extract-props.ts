...
import type { CSSProperties } from '../props/css.prop.js';
...
function extractProps<
  P extends { className?: string | object; style?: CSSProperties; [key: string]: any },
...
>(
  ...
  return extractedProps as Omit<P & { className?: string; style?: CSSProperties }, PropDefsWithClassName<T[number]>>;
}
